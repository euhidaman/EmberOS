...
# Using custom BitNet build and working model path
#

set -e

# Use the known working model from the BitNet repo
BITNET_MODEL="/home/leonardo890229/Desktop/BitNet/models/BitNet-b1.58-2B-4T/ggml-model-i2_s.gguf"
...
# Custom BitNet-compatible server binary
